...
public class HttpComponentsClientExecutor {
    ...
    public CookieStore getCookieStore(){
    	return ((DefaultHttpClient)this.httpClient).getCookieStore();
    }
    /** 
     ...
     * @throws IOException
     */
    public String doExecuteRequest(HttpUriRequest uriRequest,ResponseHandler<String> responseHandler)  throws ClientProtocolException, IOException {  
