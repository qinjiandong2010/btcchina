...
<body>
	<ul class="breadcrumb">
		...
		<li><a href="#">卖出比特币</a><span class="divider-last">&nbsp;</span></li>
	</ul>
	<div class="widget">
		<form id="sellOrderForm" method="POST" class="form-horizontal form-wizard">
			...
			<div class="widget-content no-padding">
				...
				<div class="form-row">
					<label class="field-name" for="amount">出售数额 (฿)：</label>
					<div class="field">
						<div class="input-prepend input-append">
							<input name="amount" class="span12"  maxlength="20" /> 
							<span class="add-on">在这里输入您想出售的比特币的数额。</span>
						</div>
					</div>
				</div>
				<div class="form-row">
					<label class="field-name" for="price">出售 (¥ /BTC)：</label>
					<div class="field">
						<div class="input-prepend input-append">
							<input name="price" class="span12"  maxlength="20" /> 
							<span class="add-on">在这里输入您的人民币出售，此出售为฿1.00个比特币的买入价格。</span>
						</div>
					</div>
				</div>
				<div class="form-row">
	...
	$(function() {
		$("#submit").bind("click",function(){
		  	$.ajax({
                ...
                type: "POST",
                url:"/api/trade/sell",
                data:$('#sellOrderForm').serialize(),// 你的formid
                async: false,
